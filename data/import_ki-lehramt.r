...
comment(
    df$ED03_01
) = "F1: Die Nutzung von KI-Tools verbessert meine Lehrleistung."
comment(
    df$ED03_02
) = "F1: Die Nutzung von KI-Tools reduziert mittelfristig meine Arbeitsbelastung."
comment(
    df$ED03_03
) = "F1: Die Nutzung von KI-Tools steigert die Effektivität meiner Arbeit."
...
comment(
    df$RE01_13
) = "Reflexion: Ich kann die Vertrauenswürdigkeit von KI-generierten Inhalten kritisch beurteilen."
comment(
    df$RE01_02
...
comment(
    df$RE01_06
) = "Reflexion: Ich verlasse mich auf den Vorschlag eines KI Tools mindestens genauso sehr wie ich der Empfehlung von einem/einer KollegIn vertraue."
comment(
    df$RE01_07
) = "Reflexion: Ich verlasse mich auf den Vorschlag eines KI Tools mindestens genauso sehr wie ich der Empfehlung von einem/einer ExpertIn vertraue."
comment(
    df$RE01_08
) = "Reflexion: KI-EntwicklerInnen verfügen über keine pädagogische Erfahrung."
comment(
    df$RE01_15
) = "Reflexion: Ich kann erkennen, ob ein System für den Bildungskontext erstellt wurde oder nicht."
comment(
    df$RE01_09
) = "Reflexion: Es gibt eine mangelnde Transparenz bei der Entscheidungsfindung durch KI."
comment(
    df$RE01_10
) = "Reflexion: Die Verwendung von personenbezogenen Daten birgt Risiken für die Privatsphäre von Lehrenden und Lernenden."
comment(
    df$RE01_11
) = "Reflexion: Es gibt Diskrepanzen zwischen der KI-gestützter Leistungsbewertung und der Meinung der Lehrenden."
comment(
    df$RE01_16
) = "Reflexion: Beim Einsatz von KI-gestützten Leistungbewertungen sollte die Lehrkraft am Ende über die Bewertung entscheiden."
comment(
    df$RE01_12
